...
//			setValue(FIELDNAME_BODY, articleIn);
	...
	public static final String ENDFOLDER_SUFFIX = ".article";
	...
	protected String getArticlePath(IWSlideService service){
		...
		StringBuffer path = new StringBuffer(getFolderLocation());
		path.append("/");
...
//		}
		...
		try {
			...
			slideService.createAllFoldersInPath(file.getParent());
