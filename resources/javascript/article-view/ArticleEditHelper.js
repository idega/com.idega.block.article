...
ArticleEditHelper.init = function(uriToFileBrowser,selectedGroupsParameterName,articleCategoryParameterName,selectedCategories){
	tinyMCE.init({
		...
		"cut,copy,paste,pastetext,pasteword,|,search,replace,|,bullist,numlist,|,outdent,indent,blockquote,|,undo,redo,|,link,unlink,anchor,image,cleanup,help,code,|,insertdate",
		theme_advanced_buttons2 : "inserttime,preview,|,forecolor,backcolor,tablecontrols,|,hr,removeformat,visualaid,|,sub,sup,|,charmap,emotions,iespell,media,advhr,|,print,|,ltr,rtl,|,fullscreen," +
